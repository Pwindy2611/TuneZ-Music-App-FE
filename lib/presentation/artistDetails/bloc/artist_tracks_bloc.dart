...
class ArtistTracksBloc extends Bloc<ArtistTracksEvent, ArtistTracksState> {
  final ApiService apiService;
   ...
   ArtistTracksBloc(this.apiService) : super(ArtistTracksInitial()) {
    ...
    on<ResetArtistTracksStateEvent>(_onResetState);
  }
  ...
  void _onResetState(ResetArtistTracksStateEvent event, Emitter<ArtistTracksState> emit) {
    emit(ArtistTracksInitial());
  }
}